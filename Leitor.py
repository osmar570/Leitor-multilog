...
#Esta versão foi atualizada em 22/12/2020 por Osmar Santos para tratar a leitura do valor do CPF
...
def escreve_ok_gpio():
    #GPIO.cleanup() #No rasp I do AZ1-P5 não tem essa linha e funciona o beep  -- caga role
    GPIO.setmode(GPIO.BCM)
    GPIO.setup(pinoBuzzer,GPIO.OUT)
    GPIO.output(pinoBuzzer,True)
    time.sleep(.1)
